...
class _FoundPageState extends State<FoundPage> {
 ...
 // final TextEditingController _locationController = TextEditingController();
  ...
  // Method to add a new found item post to Firestore
  Future<void> _createFoundPost() async {
  ...
  // Show a dialog to enter found item details
          ...
          children: [
            ...
            Expanded(
              child: StreamBuilder<QuerySnapshot>(
                stream: _firestore.collection('found_items').orderBy('created_at', descending: true).snapshots(),
